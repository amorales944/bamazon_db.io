...
// function idSearch(item_id, callback) {
...
//   if (err) throw err;
//   console.log("connected as id " + connection.threadId);
//   connection.query("SELECT * FROM songs WHERE artist = 'Daft Punk'", function (err, res) {
//       if (err) throw err;
//       console.log(res);
//   });
//   connection.query("SELECT * FROM songs LIMIT 200 OFFSET 150", function (err, res) {
//       if (err) throw err;
//       console.log(res);
//   });
//   connection.query("SELECT * FROM songs WHERE song_title = 'Hound Dog'", function (err, res) {
//       if (err) throw err;
//       console.log(res);
//   });
//   connection.query('SELECT artist, COUNT(*) FROM songs GROUP BY artist HAVING COUNT(*) >1'
//       , function (err, res) {
//           if (err) throw err;
//           console.log(res);
//       });
